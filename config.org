...
(setq
 ...
 mu4e-get-mail-command "mbsync schuhu obvsg gmail stefanschuh"
...
(set-email-account! "stefanschuh"
                    '((mu4e-sent-folder . "/stefanschuh/Gesendet")
                      (mu4e-drafts-folder . "/stefanschuh/Drafts")
                      (mu4e-trash-folder . "/stefanschuh/Papierkorb")
                      (mu4e-refile-folder . "/stefanschuh/Archiv")
